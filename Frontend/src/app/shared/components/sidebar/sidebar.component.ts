...
@Component({
  ...
  styles: [`
    ...
    .sidebar-toggle-btn {
      ...
      /* Ensure never hidden by overflow, z-index, opacity, or pointer-events */
      position: relative;
      z-index: 10;
      opacity: 1;
      visibility: visible;
    ...
    /* Desktop-only: hide on mobile where hamburger is used */
    .desktop-only {
      display: flex;
    }
    ...
    /* Active: restrained highlight — subtle bg + left accent, not a huge gradient */
    .nav-link.active {
