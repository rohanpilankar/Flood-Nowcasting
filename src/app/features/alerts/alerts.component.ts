    ...
    <div class="alerts-page">
      ...
      <div class="alerts-header card">
        <div class="header-text-block">
          <div class="title-with-badge">
            ...
            <span class="badge-prototype">Dispatcher Broadcast</span>
          </div>
          <p class="page-sub">Real-time simulated incident warnings and AI risk surge notifications</p>
        </div>
      ...
      @if (filteredAlerts.length > 0) {
        ...
        <app-empty-state
          ...
          description="There are no simulated flood warnings matching the selected filter criteria."
