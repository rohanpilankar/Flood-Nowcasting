      ...
      <div class="card analytics-header">
        <div class="header-left">
          <div class="title-with-badge">
            ...
            <span class="badge-prototype">Predictive Hydrology</span>
          </div>
        ...
        <div class="header-summary-chips">
          ...
          <div class="chip-item">
            ...
            <span class="c-val font-mono">~184,000 (Sim)</span>
          </div>
        </div>
      </div>
        ...
        <div class="analytics-grid-top">
          ...
          <div class="card chart-card">
            <div class="card-header">
              <div>
                <div class="title-with-badge">
                  ...
                  <span class="badge-prototype">Doppler Radar Sim</span>
                </div>
            ...
            <div class="chart-footer">
              <span class="footer-note">Simulated precipitation curve based on convective nowcasting model.</span>
            </div>
          </div>
          ...
          <div class="card leaderboard-card">
            <div class="card-header">
              <div>
                ...
                <p class="card-subtitle">Ranked by simulated AI risk score & precipitation accumulation</p>
              </div>
