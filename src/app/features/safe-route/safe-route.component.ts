        ...
        <div class="route-header-row">
          <div>
            <div class="title-with-badge">
              ...
              <span class="badge-prototype">Flood-Avoidance Engine</span>
            </div>
          ...
          <div class="map-inner-wrap">
            ...
            <div class="route-map-legend">
              ...
              <div class="legend-row">
                ...
                <span>Simulated Flood Hazard</span>
              </div>
            </div>
          </div>
        </div>
          ...
          @if (loading) {
            ...
            <div class="card route-card alternative-card">
              ...
              <div class="alternative-disclaimer">
                ...
                <span>
                  The recommended route prioritizes lower simulated flood risk and avoids deep water accumulation.
                </span>
              </div>
            </div>
            ...
            <div class="card hazards-card">
              <div class="card-header" style="margin-bottom: 0.5rem;">
                <span class="card-title" style="font-size: 0.95rem;">Simulated Active Road Hazards ({{ routePlan.hazards.length }})</span>
              </div>
