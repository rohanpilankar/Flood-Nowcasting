    ...
    <div class="settings-page">
      ...
      <div class="card settings-header">
        <div>
          <div class="title-with-badge">
            ...
            <span class="badge-prototype">Local Configuration</span>
          </div>
      ...
      <div class="settings-grid">
        ...
        <div class="card setting-section-card">
          ...
          <div class="form-fields-list">
            ...
            <div class="form-group">
              ...
              <span class="field-hint">Frequency of simulated sensor and telemetry refresh requests.</span>
            </div>
          ...
          <div class="form-fields-list">
            ...
            <div class="toggle-group">
              <div class="toggle-info">
                ...
                <span class="toggle-desc">Display simulated convective storm cells.</span>
              </div>
              <label class="switch">
        ...
        <div class="card setting-section-card">
          <div class="card-header">
            <div>
              <h3 class="card-title">Prototype Storage & State</h3>
          ...
          <div class="storage-info-box">
            ...
            <p style="margin-top: 0.5rem;">
              In Phase 2, these settings will sync with user profiles via the FastAPI backend database.
            </p>
          </div>
